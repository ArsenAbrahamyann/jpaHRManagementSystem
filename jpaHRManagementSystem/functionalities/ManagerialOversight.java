...
import jpaHRManagementSystem.entity.Manager;
...
public class ManagerialOversight {
    ...
    public static void assignManagerToDepartment() {
        ...
        String managerName = ValidationManagement.getNonEmptyInput("Name cannot be empty.");
        DepartmentManagement.printAllDepartment();
    ...
    public static void reassignManagerToDepartment() {
        ...
        int oldDepartmentId = ValidationManagement.getNonNegativeIntInput("Invalid input. " +
                                                                          "Please enter a valid department ID:");
        DepartmentManagement.printAllDepartment();
        System.out.println("Enter new department ID:");
        int newDepartmentId = ValidationManagement.getNonNegativeIntInput("Invalid input." +
                                                                          " Please enter a valid department ID:");
    ...
    public static void manageManagerialDetails() {
        ...
        do {
            ...
            try {
                managementLevel = ManagementLevel.valueOf(levelStr);
                break;
        ...
        servesMED(managerName, subordinateIds, managementLevel);
        sc.nextLine();
    }

    public static void servesMED(String managerName, List<Long> subordinateIds, ManagementLevel managementLevel) {
        try (Session session = SESSION_FACTORY.openSession()) {
            Transaction transaction = session.beginTransaction();
